...
### CREATE GEAR ####
def create_skis():
    name = skis_names[randint(0, len(skis_names)-1)]
    description = "test description for " + name
    brand = skis_brands[randint(0, len(skis_brands)-1)]
    price = randint(1, 75)
...
skis_category = Category.objects.get(name="Skis")
new_skis = create_skis()
new_skis.categories = (skis_category,)

new_image = GearImage.objects.create(photo="./skis.jpg", gear=new_skis)
new_gear_properties
